 ...
 * observable 可观察对象
 * Observer 观察者
 * Subscription  订阅之后返回一个可观测执行，常用于取消订阅
 * Operators  操作符 ，常用于对数据流进行处理
 * Subject  相当于一个EventEmitter,多播一个值或事件的唯一方法到多个观察者。
 * Schedulers 集中式调度程序来控制并发性,允许我们协调计算发生在如setTimeout requestAnimationFrame或其他人。
 *  */
